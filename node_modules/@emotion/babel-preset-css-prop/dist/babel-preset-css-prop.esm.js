...
var index = (function (api, _ref) {
  ...
  var _ref2 = _ref,
      ...
      options = _objectWithoutPropertiesLoose(_ref2, ["pragma", "sourceMap", "autoLabel", "labelFormat", "instances", "development"]);
  ...
  return {
    plugins: [options.runtime !== 'automatic' && [pragmatic, {
      "export": 'jsx',
      module: '@emotion/core',
      "import": pragmaName
    }], [development ? jsxDev : jsx, _objectSpread({}, options.runtime === 'automatic' ? {
