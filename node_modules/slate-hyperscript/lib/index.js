...
var resolveDescendants = function resolveDescendants(children) {
  ...
  try {
    for (var _iterator = children.flat()[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
...
function createElement(tagName, attributes, children) {
  return _objectSpread({}, attributes, {
    nodes: resolveDescendants(children)
  });
}
/**
...
function createValue(tagName, attributes, children) {
  ...
  var nodes = resolveDescendants(otherChildren);
...
var createFactory = function createFactory(creators) {
  var h = function h(tagName, attributes) {
